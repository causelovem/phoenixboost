...
function countRankPrice()
{
    ...
    {
        if (Number(i) <= 1499) boostPrice += 0.03;
        else
        if (Number(i) <= 1999) boostPrice += 0.04;
        else
        if (Number(i) <= 2499) boostPrice += 0.06;
        else
        if (Number(i) <= 2999) boostPrice += 0.1;
        else
        if (Number(i) <= 3499) boostPrice += 0.14;
        else
        if (Number(i) <= 3749) boostPrice += 0.24;
        else
        if (Number(i) <= 3999) boostPrice += 0.28;
        else
        if (Number(i) <= 4099) boostPrice += 0.6;
        else
        if (Number(i) <= 4199) boostPrice += 1;
        else
        if (Number(i) <= 4299) boostPrice += 1.52;
        else
        if (Number(i) <= 4400) boostPrice += 2;
    }
