...
function blockBoostType()
{
    if (boostTypeMas[curType] == "rank boost")
    {
        ...
        document.getElementById('changeBoostTextRight').innerHTML = "placements";
    ...
    if (boostTypeMas[curType] == "placements")
    {
        ...
        document.getElementById('changeBoostTextLeft').innerHTML = "rank boost";
    ...
    if (boostTypeMas[curType] == "anti-decay")
    {
        ...
        document.getElementById('changeBoostTextLeft').innerHTML = "placements";
        document.getElementById('changeBoostTextRight').innerHTML = "rank boost";
...
var boostTypeMas = ["rank boost", "placements", "anti-decay"];
var curType = 0;
var maxType = 3;
...
$(document).ready(function()
{
    $('#purchaseButton').click(function()
    {
        ...
        {
            if (currency == "usd")
            document.getElementById('orderText3').innerHTML = "Your boost from "
        ...
        {
            if (currency == "usd")
                document.getElementById('orderText3').innerHTML = "Your placements to "
        ...
        {
            if (currency == "usd")
            document.getElementById('orderText3').innerHTML = "Your anti-decay at the rank of "
